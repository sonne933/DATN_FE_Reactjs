                        ...
                        {tours.map((tour, index) => (
                            <div className="offers_item" key={tour.id}>
                                <div className="offers_image">
                                    <div className="offers_image_background" style={{ backgroundImage: `url(${tour.image && tour.image.length > 0 ? tour.image[0].url : ''})` }} />
                                    <div className="offers_name"><a href="#">{tour.title}</a></div>
                                </div>
                                <div className="offers_content">
                                    ...
                                    <div className="offers_link"><Link to={{
